import { ChevronRight, Database, Cpu, BarChart3, Zap, Brain, TrendingUp, Clock, Package, Layers, Hammer } from 'lucide-react'
...
const SERVICE_METADATA: Record<string, { description: string; dimensions: string[] }> = {
  'instruments-service': {
...
const PIPELINE_LAYERS = [
  ...
  },
  {
    ...
    color: '#a78bfa', // purple
    services: ['features-calendar-service', 'features-delta-one-service', 'features-volatility-service', 'features-onchain-service'],
  },
  {
    id: 'layer4',
...
function ServiceItem({ serviceName, metadata, layerColor, isSelected, onClick }: ServiceItemProps) {
